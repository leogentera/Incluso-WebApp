        ...
        function ($q, $scope, $location, $routeParams, $timeout, $rootScope, $http, $modal) {
            ...
            */
            ...
            $scope.logroEducativo = {
                ...
                "retosPorEtapa" :  [    { "idEtapa" : 1, "retos" : [    {"idReto": 1, "name" : "Exploración inicial", "icon" : "assets/images/img-rotator-01-lg.png", "actividades" : [ {"id" : 1, "name" : "Exploracion inicial", "status" : 1} ] },
                                                                        {"idReto": 2, "name" : "Cuarto de recursos", "icon" : "assets/images/img-rotator-01-lg.png", "actividades" : [ {"id" : 1, "name" : "Fuente de energía", "status" : 1} ] },
                                                                        {"idReto": 3, "name" : "Conócete", "icon" : "assets/images/img-rotator-01-lg.png", "actividades" : [ {"id" : 1, "name" : "Fuente de energía", "status" : 0},  {"id" : 2, "name" : "Reto múltiple", "status" : 0},  {"id" : 3, "name" : "Punto de encuentro", "status" : 0},  {"id" : 4, "name" : "Zona de contacto", "status" : 0} ]},
                                                                        {"idReto": 4, "name" : "Mis sueños", "icon" : "assets/images/img-rotator-01-lg.png",  "actividades" : [ {"id" : 1, "name" : "Fuente de energía", "status" : 0},  {"id" : 2, "name" : "Mis gustos", "status" : 0},  {"id" : 3, "name" : "Mis cualidades", "status" : 0},  {"id" : 4, "name" : "Sueña", "status" : 0},  {"id" : 5, "name" : "Punto de encuentro", "status" : 0} ] },
                                                                        {"idReto": 5, "name" : "Cabina de soporte", "icon" : "assets/images/img-rotator-01-lg.png", "actividades" : [ {"id" : 1, "name" : "Chat", "status" : 0} ]},
                                                                        {"idReto": 6, "name" : "Exploración final", "icon" : "assets/images/img-rotator-01-lg.png", "actividades" : [ {"id" : 1, "name" : "Exploracion final", "status" : 0} ]  }
                                                                    ]},
            ...
            //alert(avanceEnEtapaActual + " " + totalActividadesEnEtapaActual);
