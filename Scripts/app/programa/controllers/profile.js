...
function getDescription(id) {
    ...
    switch (id) {
        case 2:
        description = "Has ganado el suficiente 'combustible' para seguir la aventura. Â¡Buen  viaje!";
        break;
        case 3:
        description = "Has recuperado la 'Turbina C0N0-CT' ahora tienes un elemento mÃ¡s para lograr la misiÃ³n";
        break;
        case 4:
        description = "Has recuperado la 'Turbina Ala Ctu-3000' Â¡Continua el viaje!";
        break;
        case 5:
        description = "Has encontrado el 'Sistema de navegaciÃ³n' Â¡No te detengas!";
        break;
        case 6:
        description = "Has recuperado el 'Propulsor' Â¡Ahora, ve por mÃ¡s!";
        break;
        case 7:
        description = "Recuperaste los 'Misiles' Â¡Bien hecho!";
        break;
        case 8:
        description = "El 'Campo de fuerza' es tuyo. Â¡Lograste un reto mÃ¡s!";
        break;
        case 9:
        description = "Has obtenido el 'Radar' Â¡ContinÃºa la aventura!";
        break;
        case 10:
        description = "Lograste obtener el 'Tanque de oxÃ­geno' Â¡No te rindas!";
        break;
        case 11:
        description = "Es tuya la 'Sonda espacial' Â¡Sigue asÃ­!";
        break;
        case 12:
        description = "Por participar activamente, has ganado la insignia 'Foro interplanetario'";
        break;
        case 13:
        description = "Por completar tu Perfil has ganado la insignia 'ID IntergalÃ¡ctica'";
        break;
        case 14:
        description = "Por aportar activamente en la comunidad Incluso has ganado la insignia 'ParticipaciÃ³n elÃ©ctrica'";
        break;
        case 15:
        description = "Por obtener 30 likes en Foro o Comunidad has ganado la insignia 'CorazÃ³n digital'";
        break;
        case 16:
        description = "Has ganado el 'Casco'. Ahora, Â¡ve por mÃ¡s!";
        break;
        case 17:
        description = "Has ganado el 'Radio de comunicaciÃ³n'. Â¡Nunca te des por vencido!";
        break;
        case 18:
        description = "Ya es tuyo el 'Turbo' Â¡no te rindas!";
        break;
        default:
        description = "";
    }
    ...
    if (date != "NaN/NaN/NaN" && date != "") {
        var splitDate = date.split("/");
                    ...
                    if (activity.status == 0) {
                        ...
                        if (result) {
                            ...
                            activity.status = 1;   //Update activity status.
                                var profile = JSON.parse(moodleFactory.Services.GetCacheObject("profile/" + $scope.userId)); //Get local user profile.
            ...
            function phonesAreValid(phones) {
                ...
                if (phones.length > 0) {//There is at least one phone item.
                    ...
                    for (i = 0; i < phones.length; i++) {//For all items, if phone then something in phoneId too.
                        ...
                        if (phones[i].phone == "No tengo telÃ©fono") {                            
            ...
            var deleteRepeatedValues = function () {                
                ...
                // MODELS for "SocioeconÃ³micos"  --> Some of them should be validated within validateModel()                
