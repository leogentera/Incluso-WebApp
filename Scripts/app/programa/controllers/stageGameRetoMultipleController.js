                      ...
                      if (parentActivity.status == 0) {
                        if (data.escudo && data.escudo != "" && $scope.user) {
                          ...
                          for(var i= 0; i< $scope.user["strengths"].length; i++){
                              ...
                              var profileId = _.findWhere(profileCatalogs.intelligences_profile, { intelligenceid : intelligenceId}).profileid;
                              var pointsByIntelligence = { "profileId": profileId , "score": 1 , "moduleId" : $scope.retosMultipleChallenge.coursemoduleid};
                        ...
                        if (data.imagenRecortada && data.imagenRecortada != "") {
                          ...
                          encodeImageWithUri(pathImagen, "image/png", function(b64){
                            ...
                            moodleFactory.Services.PostAsyncAvatar(avatarInfo[0], function(){}, function(){console.log("failure")});
                          })
                        }else{
