         ...
         var _pageLoaded = true;
            ...
            var successGame = function (data){
                ...
                if (data.resultado) {
                  ...
                  scoreQuiz = (!scoreQuiz || !scoreQuiz.questions ? _find($scope.retoMultipleActivities, function(a){ a.name.toLowerCase().indexOf("resultadopruebas") >= 0 }) : scoreQuiz );
                  ...
                  _.each($scope.retoMultipleActivities, function(r){
                    ...
                    }else if (r.name.toLowerCase().indexOf("resultadopruebas") >= 0){
