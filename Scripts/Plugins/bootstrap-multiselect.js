	...
	Multiselect.prototype = {
		...
		defaults: {
			...
			buttonText: function (options, select) {
				if (options.length === 0) {
				    return this.nonSelectedText + ' <div class="arrow"><b class="caret"></b></div>';
				}
				else {
					if (options.length > this.numberDisplayed) {
					    return options.length + ' ' + this.nSelectedText + ' <div class="arrow"><b class="caret"></b></div>';
					}
					else {
						var selected = '';
						...
						return selected.substr(0, selected.length - 2) + ' <div class="arrow"><b class="caret"></b></div>';
					}
				}
			},
		...
		buildDropdownOptions: function () {
			...
			$('li', this.$ul).on('change', 'input', $.proxy(function (event) {
			...
			$('li', this.$ul).on('touchstart click', 'a', function (event) {
