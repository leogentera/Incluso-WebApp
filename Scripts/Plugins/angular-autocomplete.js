...
app.directive('autocomplete', function () {
	...
	return {
		...
		controller: ['$scope', '$element', '$attrs', '$rootScope', function ($scope, $element, $attrs, $rootScope) {
			...
			$rootScope.userNameReadOnly = false;
			$scope.searchParam;
		...
		template: '<div class="autocomplete">' +
					'<input type="text" ng-readonly="$parent.userNameReadOnly" name="username" data-ng-model="searchParam" ng-maxlength="100"  ng-minlength="3" required />' +
					'<ul ng-show="searchParam && completing && suggestions.length && !$parent.userNameReadOnly">' +
